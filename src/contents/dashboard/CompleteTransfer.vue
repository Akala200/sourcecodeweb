...
export default {
    ...
    methods: {
        send() {
            ...
            axios.post(`https://modez.herokuapp.com/api/send`, dataSend)
                .then(res => {
                    console.log(res)
                    Swal.fire({
...
//api
    mounted() {
        ...
        axios.get(`https://modez.herokuapp.com/api/convert?amount=${amountSelected}`)
            .then(res => {
                ...
                axios.get(`https://modez.herokuapp.com/api/coin?amount=${amountNeeded}`)
                    .then(res => {
