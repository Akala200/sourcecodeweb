        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-12 col-xxl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xl-12 col-lg-6 col-xxl-6" v-for="shortlist in shortlists" :key="shortlist.id">
                                <div class="widget-card">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="widget-stat">
                                            <div class="coin-title">
                                                <h5 class="d-inline-block ml-2 mb-3">{{shortlist.name}} <span>(24h)</span>
                                                </h5>
                                            </div>
                                            <h4>NGN  {{ Math.ceil(shortlist.quote.NGN.price)}} <span class="badge badge-success ml-2">{{shortlist.quote.NGN.percent_change_24h}}%</span>
                                            </h4>
                                        </div>
                                        <div id="btcChart"></div>
                                    </div>
