    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form">
                ...
                <div class="mt-5">
                    <router-link to="/dashboard/verify-step-5" class="btn btn-primary px-4 mr-3">Add Bank
                        Account</router-link>
                    <router-link to="/dashboard/verify-step-1" class="btn btn-success px-4">Add Debit
                        Account</router-link>
                </div>
            </div>
        </div>
