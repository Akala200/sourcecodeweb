                            ...
                            <div class="form-group col-xl-12">
                                ...
                                <div class="file-upload-wrapper" :data-text="fileName">
                                    <input name="file-upload-field" type="file"
                                           class="file-upload-field" value="" @change="updateFileName">
                                </div>
                            </div>
                            <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form @submit.prevent="submit" name="myform" class="personal_validate">
                        <div class="form-row">
                            <validate-field title="Your Name" field="full-name" :validations.sync="$v.fullName" class="col-xl-6"/>
                            <validate-field title="Email" field="email" :validations.sync="$v.email" class="col-xl-6"/>
                            <validate-field title="Date of Birth" field="dob" :validations.sync="$v.dob" type="date" class="col-xl-6"/>
                            <validate-field title="Present Address" field="present-address" :validations.sync="$v.presentAddress" class="col-xl-6"/>
                            <validate-field title="Permanent Address" field="permanent-address" :validations.sync="$v.permanentAddress" class="col-xl-6"/>
                            <validate-field title="City" field="city" :validations.sync="$v.city" class="col-xl-6"/>
                            <validate-field title="Postal Code" field="postal" :validations.sync="$v.postal" class="col-xl-6"/>

                            <validate-field title="Country" field="country" :validations.sync="$v.country" class="col-xl-6">
                                <select
